...
**Full Changelog**: https://github.com/mindflayer/python-mocket/compare/3.13.10...3.13.11
"""

full_changelog_expected = """- something"""
...
class TextMd(unittest.TestCase):
    ...
    def test_full_changelog(self):
      """
      Test removal of a "Full changelog" line generated by GitHub releases
      """
      self.assertEqual(convert_base_after(convert_markdown(full_changelog)), full_changelog_expected)
